package es.usj.mastertsa.jchueca.cities.data.repository.slite
...
const val CITIES_DATABASE = "CityDatabase.db"
...
val DELETE_DATABASE = "DROP TABLE IF EXISTS $TABLE_NAME"
